...
import LogoDell from '~/assets/images/logo-dell.svg';
...
const AboutContent = () => {
  const { schools_mapped, percent_schools_without_connectivity } =
        ...
        <div className="container">
          ...
          <div className="partners__row">
            <ul className="partners__list partners-list">
              ...
              <li className="partners-list__item">
                <LogoDell className="partners-list__image" alt="Dell" />
              </li>
              <li className="partners-list__item">
