...
export const Header = () => {
  ...
  const [isDailyCheckAppSubmenuOpen, setIsDailyCheckAppSubmenuOpen] =
    useState(false);
  ...
  useEffect(() => {
    if (!isMenuOpen) {
      ...
      setIsDailyCheckAppSubmenuOpen(false);
    }
  }, [isMenuOpen]);
        ...
        >
          ...
          <ul className="menu">
            ...
            <li
              className={clsx('menu__item', {
                'menu__item--desktop-view': !isMobile,
                'menu__item--expanded': isDailyCheckAppSubmenuOpen,
              })}
            >
              <button
                type="button"
                className={`menu__link ${
                  useRoute(dailyCheckApp) ? 'menu__link--active' : ''
                }`}
                onClick={() => {
                  if (isMobile) {
                    setIsDailyCheckAppSubmenuOpen(!isDailyCheckAppSubmenuOpen);
                  } else {
                    dailyCheckApp.navigate();
                  }
                }}
              >
                <span className="menu__link-inner">
              ...
              <ul className="menu">
                ...
                <li className="menu__item">
                  <Link
                    ...
                    className="menu__link"
                  >
                    <span className="menu__link-inner">Support</span>
                  </Link>
                </li>
                <li className="menu__item">
                  <Link
                    ...
                    className="menu__link"
                  >
                    <span className="menu__link-inner">Contact Us</span>
                  </Link>
                </li>
              </ul>
            </li>
