...
export const WorldView = () => {
  const {
    ...
    schools_without_unknown_connectivity,
    total_country_with_connectivity,
    schools_with_connectivity,
          ...
          <ul className="sidebar__list info-list">
            <li className="info-list__item">
              ...
              <h3 className="info-list__title">
                Schools' Geolocation mapped across {humanFormat(all_countries)}{' '}
                countries
              </h3>
            </li>
            <li className="info-list__item">
            ...
            <li className="info-list__item">
              ...
              <h3 className="info-list__title">
                {' '}
                of these {humanFormat(
                  schools_without_unknown_connectivity
                )}{' '}
                Schools don't have connectivity
              </h3>
            </li>
            {/* <li className="info-list__item">
