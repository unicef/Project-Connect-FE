...
export type GlobalStats = {
  ...
  schools_with_connectivity: number;
  percentage_schools_with_connectivity: number;
  total_country_with_connectivity: number;
  percent_schools_without_connectivity: number;
  schools_without_unknown_connectivity: number;
